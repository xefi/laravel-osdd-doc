...
php artisan osdd:layer functional/orders \
    ...
    --generators=controller \
    --generators=routes
# Creates routes/{web,api,console,channels}.php from stubs.
# The generated provider's withRouting(...) mounts them automatically:
#   - web    → wrapped in the 'web' middleware group
#   - api    → wrapped in 'api' middleware + the 'api' prefix
```
